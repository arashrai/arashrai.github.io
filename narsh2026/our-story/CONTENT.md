# Our Story — Content Brain Dump

Fill in each section below. I'll use this to update the timeline.

**How to use:**
- Write your brain dump under each section (as long or short as you want)
- Add image paths on their own lines starting with `IMG:`
- To add a new timeline moment, copy the template at the bottom
- To remove a section, delete it or add `SKIP` on the first line
- To change the order, just reorder the sections
...
## 4. Waterloo, Ontario, Canada (2016)
**Who:** both
...
<!-- Copy everything below this line to add a new timeline moment. -->
<!-- Paste it in the right chronological position above. -->

## XX. Title Here (YEAR)
**Who:** arash / natalie / both
