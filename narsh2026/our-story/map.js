...
const NARSH_MAP = (() => {
  ...
  const applyWarmStyleOverrides = () => {
    ...
    // Set warm atmospheric fog and globe sky
    try {
      ...
      // Cosmetic fog setting — continue if not supported
    }
  ...
  const flyToStop = (coords, zoom) => {
    ...
    const padding = isMobile
      ? { top: 70, bottom: 220, left: 16, right: 16 }
      : { top: 80, bottom: 80, left: 40, right: 460 };
